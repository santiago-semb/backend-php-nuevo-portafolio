    ...
    <div class="container-fluid">
        ...
        <form class="form" method="POST" action="../../backend/logica/crear.php" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" class="form-control" name="nombreCertificado">
            </div>
            <div>
                <label for="fechaCertificado">Fecha</label>
                <input type="text" class="form-control" name="fechaCertificado">
            </div>
            <div>
                <label for="linkCertificado">Link</label>
                <input type="text" class="form-control" name="linkCertificado">
            </div>
            <div>
