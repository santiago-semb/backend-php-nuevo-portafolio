...
<body>
    <div class="container-fluid">
        ...
        <?php 
            ...
            $data = Portafolio::getEstudioById($id);
            }
        ?>
        ...
        <form class="form" method="POST" action="../../backend/logica/actualizar.php" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" class="form-control" name="institucionEstudio" value="<?php echo $data->getInstitucion(); ?>">
            </div>
            <div>
                <label for="completoEstudio">Completo</label>
                <input type="text" class="form-control" name="completoEstudio" value="<?php echo $data->getCompleto(); ?>">
            </div>
            <div>
                <label for="fechaEstudio">Fecha</label>
                <input type="text" class="form-control" name="fechaEstudio" value="<?php echo $data->getFecha(); ?>">
            </div>
            <div>
                <label for="certificadoEstudio">Certificado</label>
                <input type="text" class="form-control" name="certificadoEstudio" value="<?php echo $data->getCertificado(); ?>">
            </div>
            <div>
                <label for="linkCertificadoEstudio">Link Certificado</label>
                <input type="text" class="form-control" name="linkCertificadoEstudio" value="<?php echo $data->getLinkCertificado(); ?>">
            </div>
            <div>
                <label for="imgEstudio">Imagen</label>
                <input type="file" class="form-control" name="imgEstudio" value="<?php echo $data->getImg(); ?>">
            </div>
