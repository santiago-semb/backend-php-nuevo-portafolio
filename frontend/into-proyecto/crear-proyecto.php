...
<body>
    <div class="container-fluid">
        ...
        <form class="form" method="POST" action="../../backend/logica/crear.php">
            ...
            <div>
                ...
                <input type="text" class="form-control" name="descripcionProyecto">
            </div>
            <div>
                <label for="lenguajesProyecto">Lenguajes</label>
                <input type="text" class="form-control" name="lenguajesProyecto">
            </div>
            <div>
                <label for="linkProyecto">Link</label>
                <input type="text" class="form-control" name="linkProyecto">
            </div>
