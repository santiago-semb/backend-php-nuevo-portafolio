    ...
    <div class="container-fluid">
        ...
        <form class="form" method="POST" action="../../backend/logica/crear.php" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" class="form-control" name="edadPersona">
            </div>
            <div>
                <label for="fechaNacimientoPersona">Fecha de nacimiento</label>
                <input type="text" class="form-control" name="fechaNacimientoPersona">
            </div>
            <div>
                <label for="telefonoPersona">Telefono</label>
                <input type="text" class="form-control" name="telefonoPersona">
            </div>
            <div>
                <label for="emailPersona">Email</label>
                <input type="text" class="form-control" name="emailPersona">
            </div>
            <div>
                <label for="direccionPersona">Direccion</label>
                <input type="text" class="form-control" name="direccionPersona">
            </div>
            <div>
                <label for="descripcionPersona">Descripcion</label>
                <input type="text" class="form-control" name="descripcionPersona">
            </div>
            <div>
                <label for="imgPersona">Imagen</label>
                <input type="file" class="form-control" name="imgPersona">
            </div>
