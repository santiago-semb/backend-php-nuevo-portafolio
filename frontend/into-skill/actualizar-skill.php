...
<body>
    <div class="container-fluid">
        ...
        <?php 
            ...
            $data = Portafolio::getSkillById($id);
            }
        ?>
        <?php if(isset($_GET["idActualizar"])): ?>
        ...
        <form class="form" method="POST" action="../../backend/logica/actualizar.php" enctype="multipart/form-data">
            ...
            <input type="hidden" name="pagina_actual" value="skill">
            <div>
                <label for="nombreSkill">Nombre</label>
                <input type="text" class="form-control" name="nombreSkill" value="<?php echo $data->getNombre(); ?>">
            </div>
            <div>
                <label for="imgSkill">Imagen</label>
                <input type="file" class="form-control" name="imgSkill" value="<?php echo $data->getImg(); ?>">
            </div>
