    ...
    <div class="container-fluid">
        ...
        <form class="form" method="POST" action="../../backend/logica/crear.php" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" class="form-control" name="lugarExp">
            </div>
            <div>
                <label for="direccionExp">Dirección</label>
                <input type="text" class="form-control" name="direccionExp">
            </div>
            <div>
                <label for="tiempoExp">Tiempo</label>
                <input type="text" class="form-control" name="tiempoExp">
            </div>
            <div>
                <label for="desdeExp">Desde</label>
                <input type="text" class="form-control" name="desdeExp">
            </div>
            <div>
                <label for="hastaExp">Hasta</label>
                <input type="text" class="form-control" name="hastaExp">
            </div>
            <div>
                <label for="descripcionExp">Descripción</label>
                <input type="text" class="form-control" name="descripcionExp">
            </div>
            <div>
                <label for="imgExp">Imagen</label>
                <input type="file" class="form-control" name="imgExp">
            </div>
