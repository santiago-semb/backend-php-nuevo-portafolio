...
<body>
    <div class="container-fluid">
        ...
        <?php 
            ...
            $data = Portafolio::getExperienciaById($id);
            }
        ?>
        ...
        <form class="form" method="POST" action="../../backend/logica/actualizar.php" enctype="multipart/form-data">
            ...
            <input type="hidden" name="pagina_actual" value="experiencia">
            <div>
                <label for="lugarExp">Lugar</label>
                <input type="text" class="form-control" name="lugarExp" value="<?php echo $data->getLugar(); ?>">
            </div>
            <div>
                <label for="direccionExp">Dirección</label>
                <input type="text" class="form-control" name="direccionExp" value="<?php echo $data->getDireccion(); ?>">
            </div>
            <div>
                <label for="tiempoExp">Tiempo</label>
                <input type="text" class="form-control" name="tiempoExp" value="<?php echo $data->getTiempo(); ?>">
            </div>
            <div>
                <label for="desdeExp">Desde</label>
                <input type="text" class="form-control" name="desdeExp" value="<?php echo $data->getDesde(); ?>">
            </div>
            <div>
                <label for="hastaExp">Hasta</label>
                <input type="text" class="form-control" name="hastaExp" value="<?php echo $data->getHasta(); ?>">
            </div>
            <div>
                <label for="descripcionExp">Descripción</label>
                <input type="text" class="form-control" name="descripcionExp" value="<?php echo $data->getDescripcion(); ?>">
            </div>
            <div>
                <label for="imgExp">Imagen</label>
                <input type="file" class="form-control" name="imgExp" value="<?php echo $data->getImg(); ?>">
            </div>
